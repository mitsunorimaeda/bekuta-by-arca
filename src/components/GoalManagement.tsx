...
import { Target, Plus, CheckCircle, Clock, TrendingUp, Trash2, X } from 'lucide-react';
                  ...
                  {goal.target_value && (
                    <>
                      <div className="mb-3">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{Math.round(progress)}% 完了</p>
                      </div>
                    </>
                  )}
