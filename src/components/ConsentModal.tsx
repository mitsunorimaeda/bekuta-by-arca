      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
              ...
              {showMinorWarning && (
                <div className="mt-4 bg-yellow-100 dark:bg-yellow-900/30 border border-yellow-400 dark:border-yellow-600 rounded-lg p-4">
                  ...
                  <p className="text-xs text-yellow-700 dark:text-yellow-300">
                    ...
                    保護者の方がいない場合は、後ほど保護者の方と一緒に再度アクセスしてください。
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="p-6 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
          <div className="flex space-x-3">
            <button
              onClick={onDecline}
              className="flex-1 py-3 px-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-medium"
            >
              同意しない
            </button>
            <button
