...
function App() {
  ...
  const { user, userProfile, loading: authLoading, requiresPasswordChange, signIn, signOut, changePassword } = useAuth();
  ...
  if (currentPage === 'reset-password') {
    return <PasswordResetConfirm onResetComplete={() => {
      // Clear the URL hash and query params
      window.history.replaceState({}, '', '/');
      // Return to app page - auth state will update automatically
      setCurrentPage('app');
    }} />;
  }
